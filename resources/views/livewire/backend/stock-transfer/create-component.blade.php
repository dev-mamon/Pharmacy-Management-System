        ...
        <div class="mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Transfer stock between branches</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="transfer_number" readonly
            ...
            <div class="space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    <h3 class="font-medium text-blue-900 mb-2">Quick Tips</h3>
                    <ul class="text-sm text-blue-700 space-y-2">
                        <li class="flex items-start gap-2">
                            <i class="fas fa-info-circle mt-0.5"></i>
                            <span>Select source branch first to see available medicines</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-info-circle mt-0.5"></i>
                        ...
                        <li class="flex items-start gap-2">
                            <i class="fas fa-info-circle mt-0.5"></i>
                            <span>Stock will be deducted from source branch immediately</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-info-circle mt-0.5"></i>
                            <span>Set status to "Completed" when transfer is physically done</span>
                        </li>
                    </ul>
                </div>
            </div>
